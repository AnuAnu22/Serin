...
def register_control_routes(app: _RouteApp) -> None:
    ...
    async def create_voice_profile(data: dict[str, Any]) -> Any:
        ...
        try:
            from serin.d1_3_state_core.voice.voice_profiles import create_profile
            name = data.get('name')
            if not name:
    ...
    async def set_active_voice_profile(profile_name: str = 'default') -> Any:
        ...
        try:
            from serin.d1_3_state_core.voice.voice_profiles import set_active_profile
    ...
    async def delete_voice_profile(profile_name: str) -> Any:
        ...
        try:
            from serin.d1_3_state_core.voice.voice_profiles import delete_profile
