...
from serin.d1_3_state_core.thinking_filter import filter_for_memory
...
def add_memory_enhanced(store: 'QdrantMemorySystem', content: str, user_id: str, **kwargs: Any) -> str | None:
        ...
        try:
            ...
            _queue_background_jobs(store, memory_ids, kwargs)
            _update_ingestion_stats(store, len(memory_ids))
