...
class ActiveSearch:
    ...
    async def analyze_need_to_search(self, user_message: str, recent_context: str, previous_results: str | None = None) -> tuple[bool, str | None, str | None]:
        """
    ...
    def _build_thinking_prompt(self, message: str, context: str, previous_results: str | None = None) -> str:
        base_prompt = """You are the internal monologue of an AI. Decide if you need to search your long-term memory to answer the user.
