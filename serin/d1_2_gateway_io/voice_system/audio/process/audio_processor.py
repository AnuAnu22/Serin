...
class AudioStreamProcessor:
    ...
    async def start(self) -> None:
        from serin.d1_2_gateway_io.voice_system.audio.audio_utils import start as _start
        return await _start(self)

    async def stop(self) -> None:
        from serin.d1_2_gateway_io.voice_system.audio.audio_utils import stop as _stop
