...
async def handle_profile_command(
    ...
    get_logger().info(f"Command: !profile from {message.author.display_name}")
    ...
    try:
        ...
        get_logger().error(f"Error in !profile command: {e}")
...
async def handle_stats_command(
    ...
    stats['commands_executed'] += 1
    get_logger().info(f"Command: !stats from {message.author.display_name}")
    ...
    try:
        ...
        get_logger().error(f"Error in !stats command: {e}")
