...
class AudioStreamProcessor:
    ...
    def __init__(self, transcriber: Any, voice_pipeline: Any, silence_threshold: float = 3.0,
        ...
        get_logger().info("voice.processor_initialized", extra={
    ...
    def process_audio_chunk(self, user_id: str, username: str, guild_id: str, channel_id: str, audio_data: bytes) -> None:
        from serin.d1_2_gateway_io.d2_2_voice_system.d3_1_system_audio.d4_3_audio_utils import (
    ...
    async def _transcribe_and_store(self, item: dict[str, Any]) -> None:
        from serin.d1_2_gateway_io.d2_2_voice_system.d3_1_system_audio.d4_2_audio_transcribe import (
